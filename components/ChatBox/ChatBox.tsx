  ...
  return (
    <>
      {status === "authenticated" ? (
        <div
          className={
            " w-screen  flex justify-center items-center  h-screen fixed z-40 top-0 left-0 bg-opacity-25 backdrop-filter backdrop-blur-lg " +
            (isVisible ? " block " : " hidden ")
          }
        >
          <div className="relative mt-20 w-[80%] h-[80%] bg-white  rounded-xl drop-shadow-2xl">
